...
export interface FooterProps {
  ...
  blocks: {
    eventCollections: DrupalTaxonomyTerm[]
    ...
    <footer className="container mx-auto py-5">
      <div className="w-full max-w-screen-xl mx-auto md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <Link href="/" className="mb-10">
            <Image src={absoluteUrl(siteInfos.siteInfos.logo)}
                   loader={loaderProp}
                   alt={siteInfos.siteInfos.name} width={120} height={30} />
          </Link>
          <ul
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          {blocks?.disclaimer && (
            <span
              className="text-sm text-gray-500 sm:text-center dark:text-gray-400"><FormattedText
              text={blocks.disclaimer.field_copyright.processed} />
          </span>
          )}
